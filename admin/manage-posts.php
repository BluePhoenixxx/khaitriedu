...
<html lang="en">
  <head>
    ...
    <!-- App title -->
    <title>KhaiTriEdu | Manage Posts</title>
    <!--Morris Chart CSS -->
...
?>
                        <tr>
                          ...
                          <td>
                            <a href="edit-post.php?pid=
																								<?php echo htmlentities($row['postid']);?>">
                              <i class="fa fa-pencil" style="color: #29b6f6;"></i>
                            </a> &nbsp; <a href="manage-posts.php?pid=
																								<?php echo htmlentities($row['postid']);?>&&action=del" onclick="return confirm('Do you reaaly want to delete ?')">
