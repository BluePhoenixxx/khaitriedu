...
echo "
<script>alert('Sub-admin details deleted.');</script>";
echo "
<script type='text/javascript'> document.location = 'manage-subadmins.php'; </script>";
}
              ...
              <div class="col-xs-12">
                <div class="page-title-box">
                  ...
                  <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active"> Manage Sub-admins </li>
                  </ol>
...
?> <tr>
                          ...
                          <td>
                            <a href="edit-subadmin.php?said=
																<?php echo htmlentities($row['id']);?>">
                              <button style="background-color: #00BFFF; color: white; border: 0">EDIT </button>
                            </a> &nbsp; <a href="manage-subadmins.php?rid=
																<?php echo htmlentities($row['id']);?>&&action=del">
                              <button style="background-color: red; color: white ;  border: 0">DELETE</button>
                          </td>
                        </tr> <?php
$cnt++;
 } ?> </tbody>
